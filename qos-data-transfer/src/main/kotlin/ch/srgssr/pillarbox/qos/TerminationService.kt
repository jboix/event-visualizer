 ...
 *
 * @property applicationContext The Spring [ApplicationContext] used to manage the application's lifecycle and exit process.
 */
@Service
class TerminationService(private val applicationContext: ApplicationContext) {
