...
/**
 * Repository interface for managing [EventRequest] entities in an Elasticsearch store.
 */
@Repository
interface ActionRepository : ElasticsearchRepository<EventRequest, String> {
   ...
   */
  fun findBySessionIdAndEventName(sessionId: String, eventName: String): EventRequest?
}
